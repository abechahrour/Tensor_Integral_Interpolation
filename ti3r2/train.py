...
def execute(data_path, C_str_feat, C_str, size_str, size_str_test, ext_str ,norm, loss, idx, idx_y,
    ...
    #x_test, y_test = get_test_data(path + 'ti4r2u' +'_data/', 'ti4r2u','C010mimi0', size_str_test,ext_str_test, idx)
    print("Count = ", count)
    ...
    plot.plot_2D(C_str, NAME, y_test[:,0], x_test, 'Actual', r'$\frac{t}{s}$', r'$\frac{m^2}{s}$', 'actual', 'symlog')
    plot.plot_2D(C_str, NAME, y_test[:,1], x_test, 'Actual', r'$\frac{t}{s}$', r'$\frac{m^2}{s}$', 'actual', 'symlog')
...
def main(argv):
    ...
    N_func = 4
    func_string=['ti4r2u', 'ti4r2u', 'ti4r2u']
